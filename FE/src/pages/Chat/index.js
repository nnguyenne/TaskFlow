...
function Chat() {
  ...
  return (
    <div className="chat">
      ...
      {/* Sidebar phải */}
      <Friends setReceiver={setReceiver} setSelectedUser={setSelectedUser} setMessages={setMessages} conversations={conversations} userList={userList} setUserList={setUserList} openFriendList={openFriendList} setOpenFriendList={setOpenFriendList} />
    </div>
  );
}
